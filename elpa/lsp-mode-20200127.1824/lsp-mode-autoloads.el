...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "lsp-clients" '(#("lsp-" 0 4 (fontified nil face font-lock-variable-name-face)))))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "lsp-csharp" '(#("lsp-csharp-" 0 11 (fontified nil)))))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "lsp-pyls" '(#("lsp-" 0 4 (fontified nil face font-lock-variable-name-face)))))
